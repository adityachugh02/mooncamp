...
- **Défi 2 :**
  ...
  - Papier de verre
  - 2 élastiques
  - Fils de fer avec pinces crocodiles
  - Voltmètre (optionnel)
...
Pour comprendre comment cela fonctionne, il faut parler de la différence de potentiel électrique. Imagine une rivière qui coule d’un endroit haut vers un endroit bas: c’est la différence de hauteur qui fait couler l’eau. En électricité, c’est une différence d’énergie entre deux points qui fait circuler les électrons (de minuscules particules chargées). Cette différence d’énergie s’appelle la différence de potentiel, et elle se mesure en volts (V).
